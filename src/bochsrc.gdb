...
plugin_ctrl: unmapped=true, biosdev=true, speaker=true, extfpuirq=true, parallel=true, serial=true, iodebug=false
...
ata0-master: type=disk, path="/home/silence/Desktop/XinOS/build/master.img", mode=flat
